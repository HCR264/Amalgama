...
GC_133 = Coupling(name = 'GC_133',
                  value = '-2*complex(0,1)*gw**2*P$IndexDelta(1,4)*P$IndexDelta(2,3)',
...
GC_134 = Coupling(name = 'GC_134',
                  value = 'complex(0,1)*gw**2*P$IndexDelta(1,3)*P$IndexDelta(2,4)',
...
GC_135 = Coupling(name = 'GC_135',
                  value = 'complex(0,1)*gw**2*P$IndexDelta(1,2)*P$IndexDelta(3,4)',
