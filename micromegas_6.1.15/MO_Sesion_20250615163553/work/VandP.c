...
{
  {"~Sdm","~Sdm",1, 9000001, "MSdm","WSdm",0,1,1,0}
...
static char*varNames_[30]={
 "lS","aEWM1","Gf","aS","ymdo","ymup","yms","ymc","ymb","ymt"
,"yme","ymm","ymtau","cabi","MSdm","MZ","Me","MMU","MTA","MU"
,"MC","MT","MD","MS","MB","MH","E","Pi","aEW","MW"
};
char**varNames=varNames_;
static REAL varValues_[30]={
   5.000000E-01,  1.279000E+02,  1.166370E-05,  1.184000E-01,  5.040000E-03,  2.550000E-03,  1.010000E-01,  1.270000E+00,  4.700000E+00,  1.720000E+02
,  5.110000E-04,  1.056600E-01,  1.777000E+00,  2.277360E-01,  7.000000E+01,  9.118760E+01,  5.110000E-04,  1.056600E-01,  1.777000E+00,  2.550000E-03
...
int calcMainFunc(void)
{
  ...
  cErr=1;
   ...
   nCurrentVars=29;
   V[29]=Pow(Pow(V[15],2)/(2.)+Pow(Pow(V[15],4)/(4.)-V[28]*V[27]*Pow(2,-0.5)*Pow(V[2],-1)*Pow(V[15],2),0.5),0.5);
