...
, {"~Sdm","~Sdm",1, 9000005, "MSdm","WSdm",0,1,1,0}
};
...
,"ymm","ymtau","cabi","lS","MZ","Me","MMU","MTA","MU","MC"
,"MT","MD","MS","MB","MH","MSdm","E","Pi","aEW","MW"
};
...
,  1.056600E-01,  1.777000E+00,  2.277360E-01,  5.000000E-01,  9.118760E+01,  5.110000E-04,  1.056600E-01,  1.777000E+00,  2.550000E-03,  1.270000E+00
,  1.720000E+02,  5.040000E-03,  1.010000E-01,  4.700000E+00,  1.250000E+02,  7.000000E+01,  2.718282E+00,  3.141593E+00};
...
int calcMainFunc(void)
{
  ...
  cErr=1;
   ...
   nCurrentVars=29;
   V[29]=Pow(Pow(V[14],2)/(2.)+Pow(Pow(V[14],4)/(4.)-V[28]*V[27]*Pow(2,-0.5)*Pow(V[1],-1)*Pow(V[14],2),0.5),0.5);
